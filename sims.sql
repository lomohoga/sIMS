...
CREATE TABLE `request` (
  ...
  CONSTRAINT `request_ibfk_1` FOREIGN KEY (`RequestedBy`) REFERENCES `user` (`Username`) ON UPDATE CASCADE,
  CONSTRAINT `request_ibfk_2` FOREIGN KEY (`ApprovedBy`) REFERENCES `user` (`Username`) ON UPDATE CASCADE,
  CONSTRAINT `request_ibfk_3` FOREIGN KEY (`IssuedBy`) REFERENCES `user` (`Username`) ON UPDATE CASCADE,
  CONSTRAINT `request_ibfk_4` FOREIGN KEY (`ReceivedBy`) REFERENCES `user` (`Username`) ON UPDATE CASCADE,
...
CREATE TABLE `request_item` (
  ...
  KEY `ItemID` (`ItemID`),
  CONSTRAINT `request_item_ibfk_1` FOREIGN KEY (`ItemID`) REFERENCES `item` (`ItemID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-26 11:21:28
